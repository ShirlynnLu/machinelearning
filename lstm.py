...
# -*- coding: utf-8 -*-
"""
Created on Thu May 31 20:32:45 2018
...
class get_stock_data():
    ...
    def make_train_test_csv(cls, orgin_data_path=None, all_data_path=None, time_step=60):
        ...
        #读取原始数据，只保留需要使用的列
        total_data = pd.read_csv(orgin_data_path, usecols=["stock_date","stock_code", "stock_name","close_hfq","high_hfq","low_hfq","open_hfq","before","rise_value", "rise_ratio","volume","value"])
        ...
        total_data = total_data[["open_hfq", "high_hfq", "low_hfq", "close_hfq", "before", "rise_value", "rise_ratio", "volume", "value"]]
        ...
        def func_train_test_data(data_one_stock_num, time_step):
            ...
            #提取输入列（对应train_x）
            data_temp_x = data_one_stock_num[["open_hfq", "high_hfq", "low_hfq", "close_hfq", "volume", "value"]]
            #提取输出列（对应train_y）
